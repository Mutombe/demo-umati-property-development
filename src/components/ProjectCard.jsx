    ...
    return (
      <div className="block group relative overflow-hidden bg-onyx-900">
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-onyx-950 via-onyx-950/40 to-onyx-950/0 pointer-events-none" />
        ...
        <a
          ...
          className="absolute top-5 right-5 sm:top-7 sm:right-7 h-11 w-11 flex items-center justify-center bg-[#25D366] hover:bg-[#1DA851] text-white transition-colors z-10"
        >
